...
insert into card (crd_name, crd_hp, crd_damage, crd_type_id) values ("Monster", 50, 50, 1),("Monster2", 70, 30, 1), ("Building",50,0,2),("Spell",0,50,3);
...
INSERT INTO user_game_card (ugc_user_game_id, ugc_crd_id, ugc_board_pos,ugc_crd_hp,ugc_crd_damage,ugc_active, ugc_crd_type) VALUES (1,1,0, 50, 50,1,1),(1,2,0, 70, 30,1,1),(1,3,0, 50, 0,1,2), (1,4,0, 0, 50,1,3), (2,1,0, 50, 50,1,1),(2,2,0, 70, 30,1,1),(2,1,0, 50, 50,1,1),(2,3,0, 50, 0,1,2), (2,4,0, 0, 50,1,3);